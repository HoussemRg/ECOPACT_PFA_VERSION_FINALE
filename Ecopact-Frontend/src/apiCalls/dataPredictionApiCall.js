...
const postPredictionFile = (file) => {
    return async (dispatch, getState) => {
      ...
      try {
        ...
        const res = await axios.post('/api/prediction/addPrediction', file, {
          headers: {
...
const getNH4AveragePredictionData=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/prediction/averageprediction/NH4`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getPxOyAveragePredictionData=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/prediction/averageprediction/PxOy`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getNO3AveragePredictionData=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/prediction/averageprediction/NO3`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getPredictionDataPerDate=(dataType,date)=>{
    return async (dispatch,getState)=>{
        try{
            const res= await axios.post(`/api/prediction/predictiondataPerDate`,{dataType,date},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
            if(dataType==="NH4"){
...
const getPredictionDataPerMonth=(dataType,month,year)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.post(`/api/prediction/predictiondataPerMonth`,{dataType,month,year},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
                if(dataType==="NH4"){
...
const getArrangementsNumber=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/prediction/arrangements`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getPredictionDataPerYear=(dataType,year)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.post(`/api/prediction/predictiondataPerYear`,{dataType,year},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
                if(dataType==="NH4"){
...
const getRecentPredictionData=(dataType)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/prediction/recentprediction/${dataType}`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
                if(dataType==="NH4"){
