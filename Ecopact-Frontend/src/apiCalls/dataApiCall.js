...
const postFile = (file) => {
    return async (dispatch, getState) => {
      ...
      try {
        ...
        const res = await axios.post('/api/data/add', file, {
          headers: {
...
const getNH4AverageData=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/data/average/NH4`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getPxOyAverageData=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/data/average/PxOy`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getNO3AverageData=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/data/average/NO3`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getDataPerDate=(dataType,date)=>{
    return async (dispatch,getState)=>{
        try{
            const res= await axios.post(`/api/data/dataPerDate`,{dataType,date},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
            if(dataType==="NH4"){
...
const getDataPerMonth=(dataType,month,year)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.post(`/api/data/dataPerMonth`,{dataType,month,year},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
                if(dataType==="NH4"){
...
const getArrangementsNumber=()=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/data/arrangements`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
...
const getDataPerYear=(dataType,year)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.post(`/api/data/dataPerYear`,{dataType,year},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
                if(dataType==="NH4"){
...
const getRecentData=(dataType)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res= await axios.get(`/api/data/recent/${dataType}`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }})
                if(dataType==="NH4"){
