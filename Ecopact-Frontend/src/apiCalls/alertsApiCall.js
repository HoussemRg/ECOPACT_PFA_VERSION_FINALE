...
const getANPEReportList=()=>{
    return async (dispatch,getState)=>{
        try{
            const res=await axios.get('/api/alerts/ANPE',{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }
            });
...
const getClientReportList=(id)=>{
    return async (dispatch,getState)=>{
        try{
            const res=await axios.get(`/api/alerts/client/${id}`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }
            });
...
const getSingleReport=(id)=>{
    return async (dispatch,getState)=>{
        try{
            ...
            const res=await axios.get(`/api/alerts/report/${id}`,{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }
            });
...
const sendAlert=(id)=>{
    return async (dispatch,getState)=>{
        try{
            const res=await axios.put(`/api/alerts/ANPE/${id}`,{},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }
            });
...
const viewAlert=(id)=>{
    return async (dispatch,getState)=>{
        try{
            const res=await axios.put(`/api/alerts/report/${id}`,{},{
                headers: {
                    Authorization: "Bearer " + getState().auth.user.token, 
                }
            });
